...
var userservices = /** @class */ (function () {
    ...
    userservices.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, database_1.default.client.connect()];
                    case 1:
                        conn = _a.sent();
    ...
    userservices.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    userservices.prototype.create = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, checkUserNameSQL, userNameRes, sql, hash, res, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                    ...
                    case 2:
                        userNameRes = _a.sent();
                        if (!(userNameRes.rows.length === 0)) return [3 /*break*/, 4];
                        sql = 'INSERT INTO users (username,firstname,lastname,password) VALUES($1,$2,$3,$4) RETURNING *;';
                        hash = bcrypt_1.default.hashSync("".concat(u.password).concat(database_1.default.pepper), parseInt(database_1.default.salt));
    ...
    userservices.prototype.authenticate = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, res, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.client.connect()];
                    case 1:
                        conn = _a.sent();
                    ...
                    case 2:
                        ...
                        if (res.rows.length) {
                            user = res.rows[0];
                            if (bcrypt_1.default.compareSync(password + database_1.default.pepper, user.password)) {
